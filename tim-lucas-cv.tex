...
\Description{\MarginText{2014}{\bf Lucas TCD}\textsuperscript{$\ast$}, Moorcroft EA\textsuperscript{$\ast$}, Freeman R, Rowcliffe MJ, Jones KE. (2014) \emph{A generalised random encounter model for estimating animal density with remote sensor data}. Methods in Ecology and Evolution. In Review.}
