...
\Description{\MarginText{Languages}R (eight years), Python, Matlab, Mathematica, Java.}
...
\Description{\MarginText{Meetings}2015\ \ $\cdotp$\ \ Presentation at Research in Progress, \href{https://rstmh.org/events/research-progress-2015}{RSTMH}}

\vspace{-0.5em}


\Description{2015\ \ $\cdotp$\ \ Presentation at \href{http://www.epidemics.elsevier.com/}{Epidemics5} conference.}

\vspace{-0.5em}

\Description{2015\ \ $\cdotp$\ \ Presentation at the National Bat Conference. [\href{http://www.slideshare.net/timcdlucas/tim-lucasnbc}{slides}]}

\vspace{-0.5em}

\Description{2015\ \ $\cdotp$\ \ Poster at British Parasitological Society Autumn Meeting.}


\vspace{-0.5em}

\Description{2014\ \ $\cdotp$\ \ Presentation at {\footnotesize CEH}, Wallingford seminar series.}

\vspace{-0.5em}

\Description{2014\ \ $\cdotp$\ \ Presentation at \href{http://id2-ox.co.uk/}{id2oxford} conference. [\href{http://www.slideshare.net/timcdlucas/tim-lucasid2ox}{slides}]}
\vspace{-0.5em}

\Description{2014\ \ $\cdotp$\ \ Poster at the {\footnotesize CoMPLEX} conference. [\href{http://figshare.com/articles/Estimating_abundance_from_camera_traps_and_acoustic_sensors/1321269}{pdf}]}
\vspace{-0.5em}
