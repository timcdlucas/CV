...
\NewEntry{2020--present}{Imperial College}
...
\Description{\MarginText{Senior Post Doc.}Models of neglected tropical diseases, contributing to software and promoting good research software practices such as version control and unit testing.}


\NewEntry{2016--2020}{University of Oxford, Malaria Atlas Project}

\Description{\MarginText{Post Doc.}I worked as a postdoctoral research scientist in geospatial epidemiology with the \href{www.malariaatlas.org}{Malaria Atlas Project} at the University of Oxford. I have made large contributions to the {\cemph first high resolution, global, space-time} estimates of both \emph{Plasmodium falciparum} and \emph{P. vivax} leading to two high-profile publications. To this end I have developed new statistical methods that combine {\cemph machine learning} and {\cemph geostatistics}. I have also supervised research assistants on smaller projects, leading to one publication.}
...
\Description{\MarginText{Research Programmer}I was the staff programmer for the Centre of Biodiversity and Environment Research at UCL. I enabled the \href{http://www.madingleymodel.org/}{Madingley Model} to run on a {\cemph high performance cluster}. and I translated code from {\cemph Mathematica to R} for analyses of 3D objects used in {\cemph paleontological research}.}
...
\vspace{1em} % Extra space between major sections
{\color{Maroon}\spacedlowsmallcaps{Other professional activites}}\vspace{1em}
...
\Description{Graham M, Ayabina D, \textbf{Lucas TCD}, \emph{et al.} (2020) \emph{SCHISTOX: An individual based model for the epidemiology and control of schistosomiasis}. Infectious Disease Modelling. In Press.}
...
\Description{2020\ \ $\cdotp$\ \ MRC Centre Early Career Research Fellowships. \emph{} Three years wages and expenses. £300,000}
\vspace{-0.5em} % Negative vertical space to counteract the vertical space between every \Description command
...
\Description{2020\ \ $\cdotp$\ \ Organised and delivered four hour workshop (twice due to demand).  ``Machine Learning in the Health Sciences''. Two hours practical workshop and two hours of case studies from members of the department.}
\vspace{-0.5em} % Negative vertical space to counteract the vertical space between every \Description command
...
\Description{2013--2014\ \ $\cdotp$\ \ Online tutor for \href{http://sysmic.ac.uk/home.html}{{\footnotesize SysMIC}}, a course for teaching quantitative skills to biologists. Answering questions online and marking assessments.}
...
{\color{Maroon}\spacedlowsmallcaps{Computational skills and Softeware}}\vspace{1em}


\Description{\MarginText{Statistical methods}Geospatial statistics, machine learning, Bayesian inference, TMB, Stan.}

\Description{\MarginText{Languages}R (expert level), Python, Matlab, Mathematica, SQL.}

\Description{\MarginText{Other}Experience in R package development, Git/Github, unit testing, continuous integration, shell/ssh and high performance computing.}
