...
\noindent{\color{Maroon}\spacedlowsmallcaps{Experience}}\vspace{1em}
...
\Description{\MarginText{Languages}R (6 years), Python, Matlab, Mathematica, Java.}
...
\Description{\MarginText{Meetings}2014\ \ $\cdotp$\ \ Poster at the {\footnotesize CoMPLEX} conference.}
