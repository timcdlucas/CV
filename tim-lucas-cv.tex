...
\Description{\MarginText{2017}Redding D, {\textbf Lucas TCD}, Heath A and Jones KE. \emph{Evaluating Bayesian spatial methods for modelling species distributions models with clumped and restricted data.} Submitted}

\Description{{\textbf Lucas TCD}, Herbots HM, \& Jones KE. \emph{A mechanistic model to compare the importance of interrelated population measures on pathogen richness: host population size, density and colony size.} In prep.}

\Description{Curnick DJ, Koldewey HJ, {\textbf Lucas TCD}, Jones KE \& Collen B. \emph{Detecting changes in pelagic shark populations using remote cameras.} In review.}
