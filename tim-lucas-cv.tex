...
\Description{\MarginText{Early Career Research Fellow} During this fellowship I am to develop statistical methods for disease mapping that properly accounts for human movement.}
...
\Description{\MarginText{2020}\textbf{Lucas TCD} (2020) \emph{A translucent box: interpretable machine learning in ecology}. Ecological Monographs.}


\Description{\MarginText{2020}\textbf{Lucas TCD}, Nandi AK,  \emph{et al.} (2020) \emph{ Improving disaggregation models of malaria incidence by ensembling non-linear models of prevalence}. Spatial and Spatiotemporal Epidemiology.}
